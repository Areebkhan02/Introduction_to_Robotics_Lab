...
%     fs = align_to_depth.process(fs); 
    ...
    if size(red_cubes) ~= 0
        for i = 1:size(red_cubes)
            if (~(250 <= red_cubes(i,1) && red_cubes(i,1) <= 348 && 165 <= red_cubes(i,2) && red_cubes(i,2) <= 275)) && 100<= red_cubes(i,1) && red_cubes(i,1) <= 509 && 67 <= red_cubes(i,2) && red_cubes(i,2) <= 424
...
%     end
    ...
    if size(blue_cubes) ~= 0
        for i = 1:size(blue_cubes)
            if (~(250 <= blue_cubes(i,1) && blue_cubes(i,1) <= 337 && 165 <= blue_cubes(i,2) && blue_cubes(i,2) <= 275)) && (100<= blue_cubes(i,1) && blue_cubes(i,1) <= 509 && 67 <= blue_cubes(i,2) && blue_cubes(i,2) <= 424)
...
%     end
    ...
    if size(yellow_cubes) ~= 0
        for i = 1:size(yellow_cubes)
            if (~(250 <= yellow_cubes(i,1) && yellow_cubes(i,1) <= 337 && 165 <= yellow_cubes(i,2) && yellow_cubes(i,2) <= 275)) && 100<= yellow_cubes(i,1) && yellow_cubes(i,1) <= 509 && 67 <= yellow_cubes(i,2) && yellow_cubes(i,2) <= 424
...
%     end
    ...
    if size(green_cubes) ~= 0
        for i = 1:size(green_cubes)
            if (~(250 <= green_cubes(i,1) && green_cubes(i,1) <= 337 && 165 <= green_cubes(i,2) && green_cubes(i,2) <= 275)) && 100<= green_cubes(i,1) && green_cubes(i,1) <= 509 && 67 <= green_cubes(i,2) && green_cubes(i,2) <= 424
